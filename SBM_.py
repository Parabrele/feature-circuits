"""
python SBM.py --generate_cov -id -act -attr -nb 1 -bs 2 -path /scratch/pyllm/dhimoila/output/SBM/id &
"""
...
parser.add_argument("--edge_threshold", "-et", type=float, default=0.)

parser.add_argument("--ctx_len", "-cl", type=int, default=16, help="Maximum sequence lenght of example sequences")

parser.add_argument("--save_path", "-path", type=str, default='/scratch/pyllm/dhimoila/output/', help="Path to save the outputs.")
...
def generate_cov():
    ...
    if DEBUG:
        ...
        gpu = 0
        for tokens, trg_idx, trg in buffer:
